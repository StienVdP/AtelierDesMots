...
public class ConfirmationModifierMot extends JFrame implements ActionListener, ItemListener {
	...
	public ConfirmationModifierMot(Controller c) {
		controller = c;
    	...
    	JLabel confirmationAjout = new JLabel("Mot modifié avec succés");
